...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "Projects",
          description: "A collection of my automotive software, ADAS, and edge AI projects.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-traffic-sign-recognition",
        ...
        section: 'Socials',
        handler: () => {
          window.open("/assets/pdf/RecepTalhaYalcinkaya_CV-tr.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%72%65%63%65%70%74%61%6C%68%61%30%38%39%39@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/recepyalcinkaya", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/recepyalcinkaya", "_blank");
        },
      },{
      id: 'light-theme',
