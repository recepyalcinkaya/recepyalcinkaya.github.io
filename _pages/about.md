...
I am a senior Computer Engineering student at Pamukkale University, graduating this year. My primary career objective is to develop cutting-edge software solutions within the automotive sector.
...
<div class="row">
    <div class="col-sm-6 mb-3">
        <figure class="m-0">
            <img src="/assets/img/teknofest_sertifikasi.jpg" class="img-fluid rounded z-depth-1" alt="TEKNOFEST Certificate" style="width: 100%; border-radius: 8px; object-fit: cover;">
        </figure>
    </div>
